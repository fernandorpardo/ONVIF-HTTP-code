...
You should have created a camera account in your camera via the Tapo app (if you don’t know how, then check [“How to view Tapo camera on PC through RTSP stream?”](https://www.tapo.com/en/faq/34/). You will need the username/password of this account for the **UsernameToken**.
